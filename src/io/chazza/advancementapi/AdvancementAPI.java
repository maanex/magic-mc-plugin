 ...
 *         JUnit-Tests, full Builder-Pattern support, Lombok
 */
...
public class AdvancementAPI {
	...
	private AdvancementAPI(NamespacedKey id, String parent, String icon, String background, TextComponent title, TextComponent description, FrameType frame, boolean announce, boolean toast,
			boolean hidden, int counter, Set<Trigger.TriggerBuilder> triggers) {
		this.id = id;
		this.parent = parent;
		this.icon = icon;
	...
	public static class AdvancementAPIBuilder {
		...
		public AdvancementAPIBuilder trigger(Trigger.TriggerBuilder trigger) {
			if (this.triggers == null) this.triggers = new ArrayList<Trigger.TriggerBuilder>();
		...
		public String toString() {
			return "io.chazza.advancementapi.AdvancementAPI.AdvancementAPIBuilder(id=" + this.id + ", parent=" + this.parent + ", icon=" + this.icon + ", background=" + this.background + ", title="
					+ this.title + ", description=" + this.description + ", frame=" + this.frame + ", announce=" + this.announce + ", toast=" + this.toast + ", hidden=" + this.hidden + ", counter="
					+ this.counter + ", triggers=" + this.triggers + ")";
		}
	}
