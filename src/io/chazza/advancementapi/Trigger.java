...
public class Trigger {
	...
	public JsonObject toJsonObject() {
		...
		if (!this.conditions.isEmpty()) triggerObj.add("conditions", advConditions);
	...
	public static class TriggerBuilder {
		...
		public Trigger.TriggerBuilder condition(Condition.ConditionBuilder condition) {
			if (this.conditions == null) this.conditions = new ArrayList<Condition.ConditionBuilder>();
			...
			switch (this.conditions == null ? 0 : this.conditions.size()) {
				...
				default:
					conditions = new java.util.LinkedHashSet<Condition.ConditionBuilder>(
							this.conditions.size() < 1073741824 ? 1 + this.conditions.size() + (this.conditions.size() - 3) / 3 : Integer.MAX_VALUE);
